...
" Filename: autoload/lightline/colorscheme/catppuccin_frappe_redux.vim
" Author: sainnhe
" Email: i@sainnhe.dev
" License: MIT License
" =============================================================================
...
let g:lightline#colorscheme#catppuccin_frappe_redux#palette = lightline#colorscheme#flatten(s:p)
"}}}
