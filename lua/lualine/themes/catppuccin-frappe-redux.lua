...
local configuration = vim.fn['catppuccin_frappe_redux#get_configuration']()
local palette = vim.fn['catppuccin_frappe_redux#get_palette'](configuration.background, configuration.foreground, configuration.colors_override)
